...
### Description
This directory is dedicated to inheritance in OOP. And we'll use Python implementation.

#### What is inherirance ?
Inheritance is the capability of one class to derive or inherit the properties from another class. And it's one of the core concepts in object-oriented programming (OOP) languages.
